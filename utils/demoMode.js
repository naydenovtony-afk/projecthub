...
export const DEMO_FILES = [
  // proj-1: Academic Research (PDF, Word, Excel, PPT, images)
  ...
  { id: 'file-3',  project_id: 'proj-1', task_id: null,      file_url: '#', file_name: 'survey-data-analysis.xlsx',         file_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', file_size: 892345,   category: 'report',       caption: 'Survey results and statistical analysis spreadsheet', uploaded_by: 'demo-user-123', uploaded_at: '2025-11-18T09:45:00Z' },
  { id: 'file-4',  project_id: 'proj-1', task_id: 'task-1',  file_url: '#', file_name: 'literature-review-presentation.pptx', file_type: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', file_size: 4230000, category: 'deliverable', caption: 'Literature review slides for team meeting',           uploaded_by: 'demo-user-123', uploaded_at: '2025-10-28T13:00:00Z' },
  { id: 'file-5',  project_id: 'proj-1', task_id: null,      file_url: '#', file_name: 'field-notes-campus.jpg',             file_type: 'image/jpeg',         file_size: 1234567,  category: 'image',        caption: 'Field observation notes from campus interviews',     uploaded_by: 'demo-user-123', uploaded_at: '2025-12-02T11:15:00Z' },

  // proj-2: Corporate Website Redesign
  { id: 'file-6',  project_id: 'proj-2', task_id: 'task-6',  file_url: '#', file_name: 'homepage-mockup.png',               file_type: 'image/png',          file_size: 3456789,  category: 'image',        caption: 'Final homepage design mockup',                       uploaded_by: 'demo-user-123', uploaded_at: '2025-11-25T16:45:00Z' },
  { id: 'file-7',  project_id: 'proj-2', task_id: 'task-6',  file_url: '#', file_name: 'wireframes-all-pages.pdf',          file_type: 'application/pdf',    file_size: 5678901,  category: 'document',     caption: 'Complete wireframes for all pages',                  uploaded_by: 'demo-user-123', uploaded_at: '2025-11-10T11:20:00Z' },
  { id: 'file-8',  project_id: 'proj-2', task_id: null,      file_url: '#', file_name: 'brand-guidelines.pdf',              file_type: 'application/pdf',    file_size: 3120000,  category: 'document',     caption: 'Updated brand guidelines and style guide',           uploaded_by: 'demo-user-123', uploaded_at: '2025-10-30T09:00:00Z' },
  { id: 'file-9',  project_id: 'proj-2', task_id: null,      file_url: '#', file_name: 'content-plan.xlsx',                 file_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', file_size: 412300,   category: 'deliverable',  caption: 'Content calendar and copy plan spreadsheet',         uploaded_by: 'demo-user-123', uploaded_at: '2025-11-03T14:30:00Z' },
  { id: 'file-10', project_id: 'proj-2', task_id: 'task-5',  file_url: '#', file_name: 'mobile-screens-preview.png',        file_type: 'image/png',          file_size: 2870000,  category: 'image',        caption: 'Mobile responsive screens preview',                  uploaded_by: 'demo-user-123', uploaded_at: '2025-11-28T10:00:00Z' },
  { id: 'file-11', project_id: 'proj-2', task_id: null,      file_url: '#', file_name: 'launch-strategy.pptx',              file_type: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', file_size: 5100000, category: 'deliverable', caption: 'Website launch strategy presentation',               uploaded_by: 'demo-user-123', uploaded_at: '2025-12-05T15:20:00Z' },

  // proj-3: EU-Funded Skills Training Programme
  { id: 'file-12', project_id: 'proj-3', task_id: 'task-10', file_url: '#', file_name: 'eu-project-proposal.pdf',           file_type: 'application/pdf',    file_size: 8901234,  category: 'deliverable',  caption: 'Official EU funding proposal submission',            uploaded_by: 'demo-user-123', uploaded_at: '2025-11-20T09:15:00Z' },
  { id: 'file-13', project_id: 'proj-3', task_id: null,      file_url: '#', file_name: 'training-curriculum-v2.docx',       file_type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', file_size: 720000,   category: 'deliverable',  caption: 'Training curriculum draft v2.0',                     uploaded_by: 'demo-user-123', uploaded_at: '2026-01-08T10:00:00Z' },
  { id: 'file-14', project_id: 'proj-3', task_id: null,      file_url: '#', file_name: 'budget-allocation.xlsx',            file_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', file_size: 345600,   category: 'report',       caption: 'EU grant budget allocation and forecast',            uploaded_by: 'demo-user-123', uploaded_at: '2025-12-12T13:45:00Z' },
  { id: 'file-15', project_id: 'proj-3', task_id: null,      file_url: '#', file_name: 'partner-logos.png',                 file_type: 'image/png',          file_size: 980000,   category: 'image',        caption: 'Partner organisation logos for branding',            uploaded_by: 'demo-user-123', uploaded_at: '2025-12-18T08:30:00Z' },
  { id: 'file-16', project_id: 'proj-3', task_id: null,      file_url: '#', file_name: 'midterm-progress-report.pdf',       file_type: 'application/pdf',    file_size: 3100000,  category: 'report',       caption: 'Midterm progress report for EU commission',          uploaded_by: 'demo-user-123', uploaded_at: '2026-01-15T11:00:00Z' },
  { id: 'file-17', project_id: 'proj-3', task_id: null,      file_url: '#', file_name: 'kickoff-meeting-slides.pptx',       file_type: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', file_size: 6400000, category: 'document',    caption: 'Project kickoff meeting presentation',               uploaded_by: 'demo-user-123', uploaded_at: '2025-09-05T09:00:00Z' },

  // proj-4: Community Health Initiative
  { id: 'file-18', project_id: 'proj-4', task_id: null,      file_url: '#', file_name: 'campaign-poster.jpg',               file_type: 'image/jpeg',         file_size: 2345678,  category: 'image',        caption: 'Health campaign promotional poster',                 uploaded_by: 'demo-user-123', uploaded_at: '2025-08-15T13:30:00Z' },
  { id: 'file-19', project_id: 'proj-4', task_id: null,      file_url: '#', file_name: 'progress-report-q4-2025.pdf',       file_type: 'application/pdf',    file_size: 4567890,  category: 'report',       caption: 'Quarterly progress report for Q4 2025',              uploaded_by: 'demo-user-123', uploaded_at: '2026-01-05T10:00:00Z' },
  { id: 'file-20', project_id: 'proj-4', task_id: null,      file_url: '#', file_name: 'outreach-schedule.xlsx',            file_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', file_size: 210000,   category: 'document',     caption: 'Community outreach schedule by district',            uploaded_by: 'demo-user-123', uploaded_at: '2025-08-20T08:00:00Z' },
  { id: 'file-21', project_id: 'proj-4', task_id: null,      file_url: '#', file_name: 'volunteer-training.pptx',           file_type: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', file_size: 3750000, category: 'deliverable', caption: 'Volunteer training presentation slides',              uploaded_by: 'demo-user-123', uploaded_at: '2025-09-10T14:00:00Z' },
  { id: 'file-22', project_id: 'proj-4', task_id: null,      file_url: '#', file_name: 'vaccination-event-photo.jpg',       file_type: 'image/jpeg',         file_size: 1890000,  category: 'image',        caption: 'Photo from community vaccination event',             uploaded_by: 'demo-user-123', uploaded_at: '2025-10-22T16:00:00Z' },

  // proj-5: Personal Portfolio (completed)
  { id: 'file-23', project_id: 'proj-5', task_id: null,      file_url: '#', file_name: 'portfolio-mockup.png',              file_type: 'image/png',          file_size: 4200000,  category: 'image',        caption: 'Final portfolio website design mockup',              uploaded_by: 'demo-user-123', uploaded_at: '2024-04-10T10:00:00Z' },
  { id: 'file-24', project_id: 'proj-5', task_id: null,      file_url: '#', file_name: 'case-studies.docx',                 file_type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', file_size: 540000,   category: 'document',     caption: 'Three case study write-ups for portfolio',           uploaded_by: 'demo-user-123', uploaded_at: '2024-05-15T11:30:00Z' },
  { id: 'file-25', project_id: 'proj-5', task_id: null,      file_url: '#', file_name: 'seo-performance-metrics.xlsx',      file_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', file_size: 290000,   category: 'report',       caption: 'Post-launch SEO and performance metrics',            uploaded_by: 'demo-user-123', uploaded_at: '2024-07-10T09:00:00Z' }
];
...
export const demoFiles = {
  getAll: () => Promise.resolve([...DEMO_FILES]),
